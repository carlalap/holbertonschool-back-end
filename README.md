...
<li>Your code should not be executed when imported (by using <code>if __name__ == &quot;__main__&quot;:</code>)</li>
 ...
 <h2 class="gap">Tasks</h2>
    ...
    <div data-role="task18913" data-position="1" id="task-num-0">
      <div class="panel panel-default task-card " id="task-18913">
  ...
  <div class="panel-body">
   ...
   <!-- Task Body -->
   <p>Write a Python script that, using this <a href="/rltoken/XNmscHBY0THdxQXM_MVzdw" title="REST API" target="_blank">REST API</a>, for a given employee ID, returns information about his/her TODO list progress.</p>
